    ...
    <div>
      <div className="section-7">
        <div className="container">
          <div className="h-p-box-8">
          <h2 className='heading-11'>Our Blog</h2>
            <p className='para-12'>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. Pregigt primasofi dede facebooka: förutom tivaligt. Fejkade</p>
          </div>
          <div className="flex-box-6">
            <div className="box-5">
              <img src="./assets/images/box-img-1.png" alt="img-1" />
              <p className='para-13'>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. </p>
              <p className='learn-more'>Learn more <svg width="26" height="12" viewBox="0 0 26 12" fill="none" xmlns="http://www.w3.org/2000/svg">
